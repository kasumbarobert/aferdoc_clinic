...
public class USSDMessagesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ussdmessages);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        recyclerView = findViewById(R.id.web_messages_recy_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(this,LinearLayoutManager.VERTICAL,false));
        chatsListRecyclerAdapter = new ChatsListRecyclerAdapter(this,new ArrayList<Message>(),Message.MESSAGE_TYPE_USSD);
    ...
    public void loadMessages(){
        ...
        jsonParams.put("action", "load_ussd");
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, Server.CONTROLLER_PATH, new JSONObject(jsonParams), new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    JSONArray songs = response.getJSONArray("ussd_messages");
                    ...
                    for(int i=0; i< songs.length(); i++){
                        ...
                        if (song_details.getString("sender_id").equals(CurrentProfile.getInstance().getCurrentDoctor().getUserId())){
                            messages.add(new USSDMessage(song_details, Message.MESSAGE_SOURCE_DOCTOR));
                        }
                        else {
                            messages.add(new USSDMessage(song_details, Message.MESSAGE_SOURCE_PATIENT));
                        }
        ...
        MyVolleySingleton.getInstance(USSDMessagesActivity.this).addToRequestQueue(jsonObjectRequest);
