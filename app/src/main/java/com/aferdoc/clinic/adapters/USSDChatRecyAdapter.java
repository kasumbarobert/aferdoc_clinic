...
public class USSDChatRecyAdapter extends RecyclerView.Adapter {
    ...
    public USSDChatRecyAdapter(Context context, List<Message> messageList) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_MESSAGE_SENT) {
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.items_ussd_sent, parent, false);
            return new USSDChatRecyAdapter.SentMessageHolder(view);
        } else if (viewType == VIEW_TYPE_MESSAGE_RECEIVED) {
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_ussd_received, parent, false);
            return new USSDChatRecyAdapter.ReceivedMessageHolder(view);
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (holder.getItemViewType()) {
            case VIEW_TYPE_MESSAGE_SENT:
                ((USSDChatRecyAdapter.SentMessageHolder) holder).bind(message);
                break;
            case VIEW_TYPE_MESSAGE_RECEIVED:
                ((USSDChatRecyAdapter.ReceivedMessageHolder) holder).bind(message);
        }
    }
    ...
    public void changeMessages(ArrayList<USSDMessage> messages) {
        mMessageList.clear();
